...
def test_all_device_drivers(
    ...
    simulated_device_list = (
        ...
        ("AWG", "AWG520050-HOSTNAME", None, None, None),
        ("AWG", "AWG5012-HOSTNAME", None, None, None),
        ("AWG", "AWG5002B-HOSTNAME", None, None, None),
        ("AWG", "AWG5012C-HOSTNAME", None, None, None),
        ("AWG", "AWG705101-HOSTNAME", None, None, None),
        ("AWG", "AWG7062B02-HOSTNAME", None, None, None),
        ("AWG", "AWG7082C01-HOSTNAME", None, None, None),
        ("AWG", "AWG70001A150-HOSTNAME", None, None, None),
        ("AWG", "AWG70002B208-HOSTNAME", None, None, None),
